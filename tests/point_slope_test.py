...
class SlopeInterceptTest(unittest.TestCase):
    ...
    def test_form(self):
        self.assertEqual(self.linear_1.form, 'Point-Slope Form')
        self.assertEqual(self.linear_2.form, 'Point-Slope Form')
        self.assertEqual(self.linear_3.form, 'Point-Slope Form')
        self.assertEqual(self.linear_4.form, 'Point-Slope Form')

    def test_x_mult(self):
        self.assertEqual(self.linear_1.x_mult, '2')
        self.assertEqual(self.linear_2.x_mult, '-3')
        self.assertEqual(self.linear_3.x_mult, '10')
        self.assertEqual(self.linear_4.x_mult, '1/2')
    ...
    def test_expressing_as_standard(self):
        self.assertEqual(self.linear_1.express_as('Standard').equation, '-2x+y=0')
        self.assertEqual(self.linear_2.express_as('Standard').equation, '3x+y=16')
        self.assertEqual(self.linear_3.express_as('Standard').equation, '-10x+y=20.5')
        self.assertEqual(self.linear_4.express_as('Standard').equation, '-1/2x+y=10.125')

    def test_expressing_as_point_slope(self):
        self.assertEqual(self.linear_1.express_as('Slope-Intercept').equation, 'y=2x+0')
        self.assertEqual(self.linear_2.express_as('Slope-Intercept').equation, 'y=-3x+16')
        self.assertEqual(self.linear_3.express_as('Slope-Intercept').equation, 'y=10x+20.5')
        self.assertEqual(self.linear_4.express_as('Slope-Intercept').equation, 'y=0.5x+10.125')
    ...
    def test_solving_for_x_on_reexpression(self):
        self.assertEqual(self.linear_1.express_as('Standard').solve_for('x', 3), 6)
        self.assertEqual(self.linear_2.express_as('Standard').solve_for('x', 9), -11)
        self.assertEqual(self.linear_3.express_as('Standard').solve_for('x', -4), -19.5)
        self.assertEqual(self.linear_4.express_as('Standard').solve_for('x', 0.5), 10.375)

    def test_solving_for_y_on_reexpression(self):
        self.assertEqual(self.linear_1.express_as('Slope-Intercept').solve_for('y', 3), 1.5)
        self.assertEqual(self.linear_2.express_as('Slope-Intercept').solve_for('y', 9), 2.3333333333333335)
        self.assertEqual(self.linear_3.express_as('Slope-Intercept').solve_for('y', -4), -2.45)
        self.assertEqual(self.linear_4.express_as('Slope-Intercept').solve_for('y', 0.5), -19.25)
