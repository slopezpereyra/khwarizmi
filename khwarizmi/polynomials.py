...
from misc import isanumber, are_operable
...
class Polynomial(Expression):
	...
	def __init__(self, polynomial, name=None):
		...
		self.expression = self.polynomial
		self.name = name
	...
	def get_terms_by_degree(self):
		...
		for term in self.terms:
			...
			if exponent in terms_by_degree and are_operable(term, terms_by_degree[exponent]):
		...
		self.terms = list(terms_by_degree.values())
...
class PolynomialOperation:
	...
	@staticmethod
	def find_term_by_degree(e, p):
		"""Returns term of degree e of polynomial p."""
